...
/*
 * from package com.sun.org.apache.xml.internal.security.utils.Base64;
...
import com.hhoss.i18n.I18n;
import com.hhoss.i18n.I18nException;
 ...
 */
public class Base64Codec0 {


   /** Field BASE64DEFAULTLENGTH */
   public static final int BASE64DEFAULTLENGTH = 76;
   private static final boolean IgnorLineBreaks = false;

   private Base64Codec0() {
    ...
    */
   public static final BigInteger decodeBigIntegerFromElement(Element element) throws I18nException
   {
    ...
    * @throws I18nException
    */
   public static final BigInteger decodeBigIntegerFromText(Text text) throws I18nException
   {
    ...
    * @throws I18nException
    */
   public static final byte[] decode(Element element) throws I18nException {
    ...
    *
    */
   public final static byte[] decode(byte[] base64) throws I18nException  {
    ...
    */
     ...
     * @throws I18nException if there is a problem decoding the data
     */
    public final static byte[] decode(String encoded) throws I18nException {
   ...
   protected final static byte[] decodeInternal(byte[] base64Data, int len) throws I18nException {
       // remove white spaces
           if (len==-1)
          len = removeWhiteSpace(base64Data);

       if (len%FOURBYTE != 0) {
           throw new I18nException("decoding.divisible.four");
       ...
       if ((b1==-1) || (b2==-1)) {
                throw new I18nException("decoding.general");//if found "no data" just return null
        }
        ...
        if ((b3==-1 ) || (b4==-1) ) {
            ...
            if (isPad( d3 ) && isPad( d4)) {               //Two PAD e.g. 3c[Pad][Pad]
                if ((b2 & 0xf) != 0)//last 4 bits should be zero
                        throw new I18nException("decoding.general");
                ...
                throw new I18nException("decoding.general");//an error  like "3c[Pad]r", "3cdX", "3cXd", "3cXX" where X is non data
            }
        } else {
            //No PAD e.g 3cQl
   ...
   public final static void decode(String base64Data,
        OutputStream os) throws I18nException, IOException {
   ...
   protected final static void decode(byte[] base64Data,
                        OutputStream os,int len) throws I18nException, IOException {
