...
public final class Digester {
    ...
    */
    ...
    public static byte[] digest(Object k, Object v) {
    	if(Fields.ignore(k)){return null;}
		try {
			return Hmac.hmac(HMAC,digest(v),Bytes.from(k));
    ...
    public static void main(String[] args) throws Exception {
		...
		System.out.println(Numeric.toHexString(Hmac.hmac(HMAC,new byte[] {9,5},new byte[] {3,0,5,7,9,2,5})));
		System.out.println(Numeric.toHexString(Hmac.hmac(HMAC,new byte[] {2,5,9,5},new byte[] {3,0,5,7,9})));
